...
console.log(makeDojo("Chicago", 65)); // log {}
console.log(makeDojo("Berkeley", 0)); // log {}
// prediction was wrong
// logged { name: 'Chicago', students: 65, hiring: true } then error for trying to assign to constant variable